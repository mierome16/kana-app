            ...
            >
              <Container>
                ...
                <Menu.Item position='right'>
                  <Link to="/restaurant-login"><Button as='a' inverted={!fixed}>
                    Log in
                  </Button></Link>
                  <Link to="/restaurant-register"><Button as='a' inverted={!fixed} primary={fixed} style={{ marginLeft: '0.5em' }}>
                    Sign Up
                  </Button></Link>
                </Menu.Item>
              </Container>
          ...
          >
            <Container>
              <Menu inverted pointing secondary size='large'>
                ...
                <Menu.Item position='right'>
                  <Link to="/restaurant-login"><Button as='a' inverted>
                    Log in
                  </Button></Link>
                  <Link to="/restaurant-register"><Button as='a' inverted style={{ marginLeft: '0.5em' }}>
                    Sign Up
                  </Button></Link>
                </Menu.Item>
              </Menu>
